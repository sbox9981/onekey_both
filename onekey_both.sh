...
then
	...
	echo 'vmess://'$(echo '{"add":"cdn.chigua.tk","aid":"0","host":"'$argo'","id":"'$uuid'","net":"ws","path":"/'$urlpath'","port":"443","ps":"argo","tls":"tls","type":"none","v":"2"}' | base64 -w 0)
else
	echo vless链接已经生成,IP地址可替换为CF优选IP
	echo 'vless://'$uuid'@cdn.chigua.tk:443?encryption=none&security=tls&type=ws&host='$argo'&path=%2f'$urlpath'#argo'
fi
rm -rf argo.log